...
- `findings/2026-04-11_SSRF_URL_PREVIEW_TRIAGE_SAMPLE.md`: Day 4 기반 샘플 finding 카드
- `findings/2026-04-12_AMOUNT_TAMPER_TRIAGE_SAMPLE.md`: Day 5 기반 샘플 finding 카드
- `findings/2026-04-13_XSS_CSRF_TRIAGE_SAMPLE.md`: Day 6 기반 샘플 finding 카드
- `findings/2026-04-14_MISCONFIG_TRIAGE_SAMPLE.md`: Day 7 기반 샘플 finding 카드
